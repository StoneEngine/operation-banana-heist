...
const STORY_SLIDES = [
  ...
  { scene: 'sneak', text: 'แต่ระวัง! บอสคองหูไวมาก มีเสียงกุกกักนิดเดียวก็ตื่นมาปาเปลือกกล้วยใส่ทันที\nเก็บกล้วยให้ได้มากที่สุดใน 45 วินาที เพื่อจัดปาร์ตี้กล้วยหอมให้ทั้งหมู่บ้าน!' },
];
