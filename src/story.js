...
const STORY_SLIDES = [
  ...
  { scene: 'sneak', text: `บอสคองสั่งลูกน้องลิงทั้งฝูงออกลาดตระเวนทั่วเกาะ เจอใครเป็นไล่ปาก้อนหินใส่ทันที\nวิ่งเก็บกล้วยที่ร่วงตามพื้น เก็บครบ ${CFG.BOSS_AT} ลูกเมื่อไหร่บอสคองจะออกมาเอง — ล้มมันให้ได้ก่อนเลือดหมด!` },
];
...
const ENDINGS = {
  ...
  gold: {
    title: '🥇 เจ้าป่าคนใหม่แห่งเกาะกล้วยหอมทองคำ!',
    pages: [
      { scene: 'end-gold', text: 'ดาบจิ๋วในมือฟาดสวนทุกก้อนหินที่บอสคองปาใส่ กระสุนดาวกระจายรัวไม่หยุด\nสู้กันสนั่นป่าจนบอสคองตัวโตล้มลงกองอยู่กลางเกาะ หมดแรงคำรามเสียงสุดท้าย' },
      { scene: 'end-gold', text: 'บอสคองยอมแพ้ ก้มหัวคารวะฝีมือ ขอเป็นบอดี้การ์ดรับใช้ตลอดไป\nเกาะกล้วยหอมทองคำได้ "จ๋อจิ๋ว" เป็นเจ้าป่าคนใหม่ ปกครองด้วยความยุติธรรม — แถมปลูกกล้วยส่งบ้านทุกเดือน' },
    ],
